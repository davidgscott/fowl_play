  ...
  sections: [
    {
      ...
      items: [
        ...
        { name: 'FLAK FULL-AUTO', unlock: 'SHOP',
          text: 'UPGRADE THE A.A. CANNON TO HOLD-DOWN FULL AUTO, THEN BUY FIRE-RATE BOOSTS. PRICEY - AND ABSOLUTELY DEVASTATING.' },
      ],
    },
    {
      title: 'NEW WEAPONS',
      ...
      items: [
        ...
        { name: 'SNIPER RIFLE', unlock: 'LVL 7',
          text: 'HOLD SHIFT TO ZOOM IN AND POP A HEAD FROM CLEAR ACROSS THE MAP. LET GO TO FIRE FROM THE HIP - LAND A HEADSHOT THAT WAY AND YOU GET A NO SCOPE FOR TRIPLE POINTS!' },
        ...
        { name: 'SHOTGUN - BUFFED!', unlock: 'LVL 1',
          text: 'THE SPREAD IS WAY WIDER AND IT HITS WAY HARDER. WADE INTO A FLOCK AND TAKE OUT THREE OR FOUR AT ONCE!' },
